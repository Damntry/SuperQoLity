					...
					case 2:
						switch (state) {
							case 0:
								...
								component.productAvailableArray = ContainerSearchHelpers.CheckProductAvailability(__instance);
							...
							case 4: {
									...
									if (component.NetworkboxNumberOfProducts > 0 && ContainerSearchHelpers.CheckIfShelfWithSameProduct(__instance, targetShelfInfo.ExtraData.ProductId, component, out ProductShelfSlotInfo productShelfSlotInfo)) {
