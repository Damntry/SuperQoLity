...
namespace SuperQoLity.SuperMarket.PatchClassHelpers.NPCs.JobScheduler.AutoMode.DataDefinition {
	...
	public class PerformanceMode : AutoModeData {
		...
		public PerformanceMode() : base(
            ...
            avgCustomerWaitTargetMillis: 400f,
	...
	public class BalancedMode : AutoModeData {
		...
		public BalancedMode() : base(
            ...
            avgCustomerWaitTargetMillis: 250f,
            minFreqMult: 0.33f,
			maxFreqMult: 8f,
			decreaseStep: 0.90f,
			increaseStep: 0.90f
	...
	public class AggressiveMode : AutoModeData {
		...
		public AggressiveMode() : base(
            ...
            avgCustomerWaitTargetMillis: -1f,
            minFreqMult: 0.5f,
	...
	public class CustomMode : AutoModeData {
		//If just processing npcs takes more than this, might as well go back to play minesweeper.
		public static readonly float MaxAllowedProcessingTime = 1000 / 60f;	//60 fps if cpu time was only npc processing.
		public CustomMode() : base(
			jobFreqMode: EnumJobFrequencyMultMode.Auto_Custom,
			defaultFrequencyMult: 1f,
            avgEmployeeWaitTargetMillis: ModConfig.Instance.CustomEmployeeWaitTarget.Value,
            avgCustomerWaitTargetMillis: ModConfig.Instance.CustomCustomerWaitTarget.Value,
